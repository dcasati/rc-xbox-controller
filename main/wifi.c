...
esp_err_t wifi_init_sta(void) {
    ...
    wifi_config_t wifi_config = {
        .sta = {
            .ssid = CONFIG_RC_WIFI_SSID,
            .password = CONFIG_RC_WIFI_PASSWORD,
    ...
    ESP_LOGI(TAG, "Connecting to SSID: %s", CONFIG_RC_WIFI_SSID);
    ...
    if (bits & WIFI_CONNECTED_BIT) {
        ESP_LOGI(TAG, "Wi-Fi connected to %s", CONFIG_RC_WIFI_SSID);
        return ESP_OK;
    }
